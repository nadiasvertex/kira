...
enum class semantic_scope_kind : uint8_t {
  ...
  function_signature_scope, ///< Parameter list and type parameters of a function.
...
struct semantic_scope {
  ...
  semantic_scope_kind kind = semantic_scope_kind::block_scope; ///< What introduced this scope.
