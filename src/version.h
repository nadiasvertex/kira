...
inline constexpr unsigned k_version_minor = 16;
...
inline constexpr std::string_view k_version_string = "0.16.0";
...
inline constexpr std::string_view k_release_date = "2026-07-20";
