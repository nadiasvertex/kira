...
inline constexpr unsigned k_version_minor = 4;
...
inline constexpr std::string_view k_version_string = "0.4.0";
...
inline constexpr std::string_view k_release_date = "2026-07-16";
