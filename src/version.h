...
inline constexpr unsigned k_version_minor = 28;
...
inline constexpr std::string_view k_version_string = "0.28.0";
...
inline constexpr std::string_view k_release_date = "2026-09-22";
