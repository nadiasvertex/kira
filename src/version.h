...
inline constexpr unsigned k_version_minor = 24;
...
inline constexpr std::string_view k_version_string = "0.24.0";
...
inline constexpr std::string_view k_release_date = "2026-09-13";
